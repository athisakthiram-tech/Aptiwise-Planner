...
import { Plan886Configurator } from "@/components/planner/Plan886Configurator";
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 sm:items-center">
      <div className="w-full max-w-md rounded-t-2xl sm:rounded-2xl bg-white p-5 max-h-[85vh] overflow-y-auto">
        ...
        <div className="mt-5 flex flex-col gap-4 text-sm">
          ...
          ) : product.planNumber === "867" ? (
            <Plan867Configurator product={product} goal={goal} locale={locale} />
